        ...
        <main>
            ...
            <article>
                <section id="english" className="show">
                    ...
                    <p>
                        Currently he is <strong>software engineer</strong> at
                        <strong>
                ...
                <section id="portuguese" className="hide">
                    <p>
                        ...
                        <strong>
                            <a href="https://www.mackenzie.br/en/universidade/unidades-academicas/fci-computing-and-informatics-department/">
                                Faculdade de Computação e Informática (FCI) - Universidade Mackenzie
                            </a>
                        </strong>
                        .
                    </p>
                    ...
                    <p>
                        ...
                        <span className="currentlyAge">&nbsp;</span> anos de idade, fez curso
